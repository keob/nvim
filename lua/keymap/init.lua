...
map('n', '{s', ':lua vim.lsp.buf.document_symbol()<CR>')
map('n', '}s', ':lua vim.lsp.buf.workspace_symbol()<CR>')
...
map('n', '<leader>aw', ':lua vim.lsp.buf.add_workspace_folder()<CR>')
map('n', '<leader>rw', ':lua vim.lsp.buf.remove_workspace_folder()<CR>')
map('n', '<leader>lw', ':lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>')
